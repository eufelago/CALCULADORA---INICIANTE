# importando tkinter
from tkinter import * # asterisco significa importar tudo que existe dentro daquela biblioteca no caso a "tkinter"
...
b_7 = Button(frame_corpo, command= lambda: entrada_valores('*'), text="X", width=5, height=2, bg=cor5, fg=cor2 , font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b_3 = Button(frame_corpo, command= lambda: entrada_valores('0'), text="0", width=11, height=2, bg=cor4, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_3.place(x=0, y=208)
b_14 = Button(frame_corpo, command= lambda: entrada_valores('.'), text=".", width=5, height=2, bg=cor4, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
